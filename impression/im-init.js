function initText() {
    for (var n = 0; n < 5; n++) {
        ...
        setText(`imUp${n+1}R`, imValMul[n].smartToString(0, 'gray', 6));
    ...
    setText('imP1', imP1Req().smartToString(0, 'white', 6));
    setText('imPV1', 'Currently: ×' + imMul.smartToString(0, 'gray', 6));
    setText('imP2', imP2Req().smartToString(0, 'white', 6) + '&nbspFifth');
...
function loadGame() {
    ...
    if (savegame !== null) {
        ...
        if (typeof savegame.imMemory !== 'undefined') {
            imMemory = new BigNum(savegame.imMemory.man, savegame.imMemory.exp);
        }
