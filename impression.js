...
function imUp1Update() {
    ...
    setText('imUp1R', imUp1Value().smartToString(0, 'gray', 6));
}

function imUp2Update() {
    imUp1T = BigNum.add(
        imUp1T,
        BigNum.div(
            imUp2Value(),
    ...
    setText('imUp2R', imUp2Value().smartToString(0, 'gray'));
}

function imUp3Update() {
    imUp2T = BigNum.add(
        imUp2T,
        BigNum.div(
            imUp3Value(),
...
setInterval(function() {
    ...
    setText('imUp1T', imUp1T.smartToString(0, 'black', 6));
    setText('imUp2T', imUp2T.smartToString(0, 'black', 6));
    setText('imUp3T', imUp3T.smartToString(0, 'black', 6));
